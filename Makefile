...
content:
	...
	$(BIN)/marked -i doc/a-fundacion/historia-gl.md -o templates/a-fundacion/historia-gl.html
	$(BIN)/marked -i doc/a-fundacion/historia-es.md -o templates/a-fundacion/historia-es.html
	$(BIN)/marked -i doc/a-fundacion/historia-en.md -o templates/a-fundacion/historia-en.html
	$(BIN)/marked -i doc/a-fundacion/obxectivos-gl.md -o templates/a-fundacion/obxectivos-gl.html
	$(BIN)/marked -i doc/a-fundacion/obxectivos-es.md -o templates/a-fundacion/obxectivos-es.html
	$(BIN)/marked -i doc/a-fundacion/obxectivos-en.md -o templates/a-fundacion/obxectivos-en.html

historico:
	$(shell for i in {1994..2014}; do echo -e "{\n}" > "backend/public/portada/xornadas-tecnicas/historico/${i}.json"; done)

repair:
	echo "{\n}" > locale/strings-en.json
	echo "{\n}" > locale/strings-es.json
	echo "{\n}" > locale/strings-gl.json
...
# content generator
generate-content:
	node -e "require('./backend/generator')()"

.PHONY: coverage clean test content historico
